...
const Exam07=()=>{
    ...
    const checkMember = ()=>{
        ...
        //PW-RE검사
        const pwReMatch = member.memberPwRe.length === 0 ? null : member.memberPw.length > 0
        ...
        <div className="container-fluid">
            <div className="row">
                <div className="col-md-10 offset-md-1">
                    ...
                    {/* 점보트론 */}
                    <div className="row">
                        <div className="col p-4 text-light bg-dark rounded">
                            <h1 className="text-center">회원가입</h1>  
                            <h3 className="text-center">객체 상태 변수 문제</h3>                  
                        </div>
                    </div>
                    <form>
                    <div className="row mt-4">
                        <div className="col">
                            <div className="form-floating">
                                <input type="text" name="memberId" placeholder="안보여"
                                    className={`
                                        form-control 
                    ...
                    <div className="row mt-4">
                        <div className="col">
                            <div className="form-floating">
                                <input type="password" name="memberPw" placeholder="안보여"
                                    className={`
                                        form-control
                    ...
                    <div className="row mt-4">
                        <div className="col">
                            <div className="form-floating">
                                <input type="password" name="memberPwRe" placeholder="안보여"
                                     className={`
                                        form-control
